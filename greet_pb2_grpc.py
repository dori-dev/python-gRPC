...
class Greeter(object):
    ...
    def SayHello(
        ...
        return grpc.experimental.unary_unary(
            request, target, '/greet.Greeter/SayHello',
    ...
    def ParrotSaysHello(
        ...
        return grpc.experimental.unary_stream(
            request, target, '/greet.Greeter/ParrotSaysHello',
            greet__pb2.HelloRequest.SerializeToString,
            greet__pb2.HelloReply.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression,
    ...
    def ChattyClientSaysHello(
        ...
        return grpc.experimental.stream_unary(
            request_iterator, target, '/greet.Greeter/ChattyClientSaysHello',
            greet__pb2.HelloRequest.SerializeToString,
    ...
    def InteractingHello(
        ...
        return grpc.experimental.stream_stream(
            request_iterator, target, '/greet.Greeter/InteractingHello',
            greet__pb2.HelloRequest.SerializeToString,
            greet__pb2.HelloReply.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression,
